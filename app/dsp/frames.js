...
export function frameGrid(numSamples, sampleRate, frameMs = DEFAULT_FRAME_MS, hopMs = DEFAULT_HOP_MS) {
    ...
    return {
        ...
        hopLen,
        count,
        timeAt: (i) => (i * hopLen + frameLen / 2) / sampleRate,
    };
}
/** Copia o frame i para `out` (realoca se necessario). */
export function readFrame(x, grid, i, out) {
